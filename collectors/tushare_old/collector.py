...
Import chain:
  .env (QUICKSYNC_URL) → tushare_common (token) → tushare_api (_call)
"""
...
# ---------------------------------------------------------------------------
# Load .env before importing tushare modules so they can pick up QUICKSYNC_URL.
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Import chain: .env (QUICKSYNC_URL) → tushare_common (token) → tushare_api (_call)
# ---------------------------------------------------------------------------

from .tushare_api import _call  # noqa: E402
