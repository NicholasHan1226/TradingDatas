#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""DEPRECATED: SharedSignals lightweight capability HTTP API server.

This legacy server only exposes capability metadata. Use ../api_server.py for
the authenticated SharedSignals data API.
...
Usage:
  python3 tools/api_server.py [--port 8083] [--host 0.0.0.0]
...
def main() -> int:
    ...
    print("[api_server] WARNING: tools/api_server.py is deprecated; use ../api_server.py for data API traffic")
