...
- Data also keeps connected contracts, historical collection observations, candidate sources, and the integration roadmap as four separate states. Never turn source discovery, technical reachability, registry activation, a historical success, or an unverified licence into a live, stable, redistributable, or sellable claim.
