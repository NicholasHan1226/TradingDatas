...
limits received an editorial pass, not a fresh full-text review of 43 papers.
Three guides gain source-bounded measurement detail; 200 works / 43 guides remain.
The internal-note guard now covers headings, summaries and limitations too.

All 99 tests and build pass. All 24 HTTP artifacts match generated bytes; 12
notebooks execute in real kernels. Browser checks confirm cross-language bookmark
identity, contents/fragment placement and topic/page/scroll return. Chinese/light
390/768px body layout was checked for three guides, English/dark for two. Native
touch, complete keyboard traversal, spoken accessibility, actual browser saves
and independent PM release approval remain open. Full evidence and source-access
limits: `../docs/design/research-editorial-polish-v10.md`. No production claim.
