...
# 2026-08-31 — Corporate questions continuation

Candidate only: 200 works, 43 bilingual guides; three new corporate guides and
three question routes / nine existing works. Full evidence and bounded source
reading: `../docs/design/research-corporate-questions-v9.md`.

Build and 95 tests passed. All three new articles opened in Chinese/light and
English/dark with six sections/source locators/contents links and no desktop
horizontal overflow. Contents click focuses section 3 with 110px header clearance;
reopening the fragment now works after fixing the generic route-entry scroll reset.
English/dark body wrapping checked in 390/768px iframes, not native touch devices.
24 HTTP artifacts matched generated bytes; 12 notebooks executed in actual
isolated kernels. Native browser save completion and screen-reader speech remain
unverified. No production release or independent review is implied.
