...
function plannedDataset({ id, title, description, family, category, market, detail, tags, cadence, plan, source }) {
  return {
    ...
    lastSuccess: null,
    stability: "—",
    stabilityNote: { en: "not verified on this page", zh: "本页未核验采集历史" },
    delayedDays: [],
    source,
    receipt: null,
    ...
    datasets: [
      {
        ...
        plan: "Product definition · authenticated readback required",
        evidence: { kind: "unverified" },
        coverage: null,
        lastSuccess: null,
        stability: "—",
        stabilityNote: { en: "not verified on this page", zh: "本页未核验采集历史" },
        delayedDays: [],
        source: "Tushare contract via QuickSync · runtime source not bound here",
        receipt: null,
        fields: 5,
        sampleColumns: ["trade_date", "ts_code", "open", "close", "vol"],
        sampleRows: [
