...
<div className="account-nav-group"><a href="/docs" onClick={event => navigate(event,"/docs")}>Docs</a><a href="/connect" onClick={event => navigate(event,"/connect")}>Agent / MCP</a></div>
              ...
              <article className="account-detail">
                ...
                {primaryRoute === "account" && !accountChecking && accountSection === "subscription" && <AccountCommerce key={accountData.user_id || accountData.tenant_id} account={accountData} locale={locale} section="subscription" navigate={navigate} />}
                ...
                {accountPrivateSection && accountChecking ? (
                  ...
                  <AccountCommerce key={accountData.user_id || accountData.tenant_id} account={accountData} locale={locale} section="billing" navigate={navigate} />
