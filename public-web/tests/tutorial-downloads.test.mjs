...
import { tutorialDownloadFiles } from "../scripts/build-tutorial-downloads.mjs";
import { tutorialExamples } from "../src/tutorialExamples.js";

const names = { "adjusted-price-series": "adjust_prices", "pit-fundamentals-panel": "select_as_of", "company-event-timeline": "align_events" };
...
test("download artifacts share synthetic inputs and JS output, and six notebooks execute top-to-bottom", () => {
