...
test("15 supported extensions coexist with 60 guides, 200 works and one honest source gap", () => {
  ...
  assert.equal(Object.values(researchReaderNotes).filter(g => g.sections.length === 6).length, 59);
