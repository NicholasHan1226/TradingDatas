...
test("ten earlier source-bounded additions coexist within 160 guides without inventing works", () => {
  ...
  assert.equal(auditContent().review.filter(r => r.code === "summary_only").length, 40);
});
