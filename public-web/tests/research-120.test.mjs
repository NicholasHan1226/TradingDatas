...
test("200 bilingual guides keep the 200 identities and the honest accrual source gap", () => {
  ...
  assert.equal(auditContent().review.filter(x => x.code === "summary_only").length, 0);
