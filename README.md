...
当前 `main` 的 190 项 runtime registry 仅保留有纵向证据的 26 个 active dataset：原有
...
`direct_wave_4` 中 11 个仅按需调用的数据集；其余 164 个全部 paused。除原五项外的
...
当前仓库正式 registry 为 26 active / 164 paused；用当前 main compiler 重编仓外
