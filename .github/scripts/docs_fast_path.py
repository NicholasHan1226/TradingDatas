...
DOCS = frozenset(['AGENTS.md', 'README.md', 'ROADMAP.md', 'STATUS.md', 'docs/AGENTS.md', 'docs/ARCHITECTURE.md', 'docs/API.md', 'docs/OPERATIONS.md', 'docs/AUTHORITY_AND_HISTORY.md'])
