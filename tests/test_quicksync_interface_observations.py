...
def test_synthetic_https_activation_evidence_freezes_safe_schema_and_bindings() -> None:
    ...
    # never appear in its candidate projection.  The gap is 21 once
    # pledge_detail joins the seed-dependent active set with pledge_stat.
    _SYNTHETIC_FIXTURE_UNEVIDENCED_ACTIVE_APIS = 21
