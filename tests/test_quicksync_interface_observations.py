...
def test_synthetic_https_activation_evidence_freezes_safe_schema_and_bindings() -> None:
    ...
    # never appear in its candidate projection.  The gap is 25 once
    # dc_concept_cons / dc_member / fund_daily join the seed-dependent
    # active set with etf_mins and stk_mins.
    _SYNTHETIC_FIXTURE_UNEVIDENCED_ACTIVE_APIS = 25
